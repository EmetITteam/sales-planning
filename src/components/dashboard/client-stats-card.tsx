...
export function ClientStatsCard({ stats, loading = false, index = 3 }: ClientStatsCardProps) {
  ...
  if (showSkeleton) {
    return (
      <div className="glass-card p-3 md:p-4 fade-stagger" style={{ ['--i' as string]: index }}>
  ...
  return (
    <div className="glass-card p-3 md:p-4 fade-stagger transition-all hover:-translate-y-px hover:shadow-[0_8px_30px_rgba(6,42,61,0.06)]" style={{ ['--i' as string]: index }}>
