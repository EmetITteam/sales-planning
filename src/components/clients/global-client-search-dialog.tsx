      ...
      <Drawer.Portal>
        ...
        <Drawer.Content
          ...
          className="
            ...
            h-[96dvh] rounded-t-3xl shadow-[0_-8px_40px_rgba(6,42,61,0.20)]
            md:bottom-auto md:top-1/2 md:left-1/2 md:right-auto md:-translate-x-1/2 md:-translate-y-1/2
            md:w-[560px] md:max-w-[calc(100vw-32px)] md:h-[640px] md:max-h-[calc(100vh-64px)]
            md:rounded-3xl md:shadow-[0_24px_60px_rgba(6,42,61,0.25)]
          "
        >
          {/* Drag handle тільки на mobile (drag-to-dismiss). На desktop
              модалка центрована, drag не має сенсу. */}
