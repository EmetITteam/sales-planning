...
// PWA / favicon 512×512 — EMET-знак білим на фірмовому навакі #081E2D.
// Знак рендеримо як <img> з data-URI SVG (resvg у next/og растеризує надійніше
// за inline <svg> у Satori). Раніше був текст «EMÉT».
export const size = { width: 512, height: 512 };
export const contentType = 'image/png';

// Білий знак (emet-mark) — fill #fff для контрасту на навакі.
const MARK_SVG =
  ...
  return new ImageResponse(
    (
      ...
      >
        ...
        <img src={MARK_URI} width={320} height={305} alt="EMET" />
      </div>
    ),
    { ...size },
  );
