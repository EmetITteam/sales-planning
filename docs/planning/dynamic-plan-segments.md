...
### 11.1 Додатковий рядок «Без динамічного бренду» (region-accordion)
Під головним рядком регіону показуємо ДРУГИЙ рядок — ті самі «Запл. %·сума / План», але **повністю БЕЗ dynamic-сегментів** (тільки звичайні бренди):
```
